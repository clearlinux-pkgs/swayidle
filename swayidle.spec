...
Version  : 1.7
Release  : 5
URL      : https://github.com/swaywm/swayidle/archive/1.7/swayidle-1.7.tar.gz
Source0  : https://github.com/swaywm/swayidle/archive/1.7/swayidle-1.7.tar.gz
...
%prep
%setup -q -n swayidle-1.7
cd %{_builddir}/swayidle-1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629214691
...
cp %{_builddir}/swayidle-1.7/LICENSE %{buildroot}/usr/share/package-licenses/swayidle/701a0d07ac28d9dadb4826db3bf2176efc7316c4
