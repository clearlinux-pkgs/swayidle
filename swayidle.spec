...
Version  : 1.7.1
Release  : 6
URL      : https://github.com/swaywm/swayidle/archive/1.7.1/swayidle-1.7.1.tar.gz
Source0  : https://github.com/swaywm/swayidle/archive/1.7.1/swayidle-1.7.1.tar.gz
...
%prep
%setup -q -n swayidle-1.7.1
cd %{_builddir}/swayidle-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644424560
...
cp %{_builddir}/swayidle-1.7.1/LICENSE %{buildroot}/usr/share/package-licenses/swayidle/701a0d07ac28d9dadb4826db3bf2176efc7316c4
