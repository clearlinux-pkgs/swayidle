...
Version  : 1.6
Release  : 4
URL      : https://github.com/swaywm/swayidle/archive/1.6/swayidle-1.6.tar.gz
Source0  : https://github.com/swaywm/swayidle/archive/1.6/swayidle-1.6.tar.gz
...
%prep
%setup -q -n swayidle-1.6
cd %{_builddir}/swayidle-1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579734576
...
cp %{_builddir}/swayidle-1.6/LICENSE %{buildroot}/usr/share/package-licenses/swayidle/701a0d07ac28d9dadb4826db3bf2176efc7316c4
